...
typedef _Complex float  GFC_COMPLEX_16;

#define HAVE_GFC_REAL_16
#define HAVE_GFC_COMPLEX_16
#define GFC_REAL_16_HUGE 1.18973149535723176502e4932l
#define GFC_REAL_16_LITERAL_SUFFIX 
#define GFC_REAL_16_LITERAL(X) (X)
